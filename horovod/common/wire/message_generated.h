...
struct Request FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool cross_only() const {
    return GetField<uint8_t>(VT_CROSS_ONLY, 0) != 0;
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint8_t>(verifier, VT_CROSS_ONLY) &&
           verifier.EndTable();
  }
};
...
struct RequestBuilder {
  ...
  void add_cross_only(bool cross_only) {
    fbb_.AddElement<uint8_t>(Request::VT_CROSS_ONLY, static_cast<uint8_t>(cross_only), 0);
  }
...
inline flatbuffers::Offset<Request> CreateRequest(
  ...
  builder_.add_cross_only(cross_only);
...
struct ResponseBuilder {
  ...
  void add_cross_only(bool cross_only) {
    fbb_.AddElement<uint8_t>(Response::VT_CROSS_ONLY, static_cast<uint8_t>(cross_only), 0);
  }
